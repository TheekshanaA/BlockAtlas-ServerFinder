    ...
    public void updateServerList(){
        ...
        MinecraftClient.getInstance().execute(()->{
            ...
            for (Server server : new ArrayList<>(serverList)) {
                ...
                if (server.featured()) {
                    e.addDrawable((a, b, c, d) -> a.drawTexture(RenderPipelines.GUI_TEXTURED, Identifier.of("blockatlas", "textures/gui/featuredtext.png"), 54 + textRenderer.getWidth(server.server_name()), 5, 0, 0, 51, 7, 51, 7));
                }
